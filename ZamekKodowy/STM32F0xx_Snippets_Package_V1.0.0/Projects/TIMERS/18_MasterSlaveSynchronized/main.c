/**
 ...
 ===============================================================================
    - This example configures the TIM1 and TIM2 in order to start them 
      synchronously.
      Timer 1 is in master mode with CEN used as TRGO.
      ...
      TIM2_CH1 also.
      TIM1_CH1 and TIM2_CH1 are configured with the same PWM.
      To monitor the signals, use an oscilloscope on PA8 for TIM1_CH1 and PA5
      for TIM2_CH1.
      Due to PA5 characteristics, the slope are not as fast as on PA8.
...
__INLINE void ConfigureTIMxSynchroWithTIMy(void)
{
  ...
  /* (1) Configure Timer 1 master mode to send its enable signal 
         as trigger output (MMS=001 in the TIM1_CR2 register). */
  /* (2) Configure the Timer 1 Channel 1 waveform (TIM1_CCMR1 register)
