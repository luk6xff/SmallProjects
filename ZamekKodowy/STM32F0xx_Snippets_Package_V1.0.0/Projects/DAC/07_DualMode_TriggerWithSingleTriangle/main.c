/**
  ******************************************************************************
  * @file    07_DualMode_TriggerWithSingleTriangle/main.c 
  ...
  *          by its own timer. Each channel having its own triangle wave
  *          with the same amplitude but its own frequency.
 ===============================================================================
                    #####       MCU Resources     #####
 ===============================================================================
   - RCC
 ...
 ===============================================================================
    ...
    - The DAC is configured to generate the same amplitude  triangle wave on 
      each channel but with a different frequency due to different external 
      trigger.
