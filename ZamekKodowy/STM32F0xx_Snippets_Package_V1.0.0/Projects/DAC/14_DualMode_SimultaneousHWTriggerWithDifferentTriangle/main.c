/**
  ******************************************************************************
  * @file    14_DualMode_SimultaneousHWTriggerWithDfferentTriangle/main.c 
  * @author  MCD Application Team
  * @version V1.0.0
  * @date    05-March-2014
  * @brief   This code example shows how to configure the DAC in dual mode 
  *          in order to generate two simultaneous triangle waves, each channel  
  *          triggered by the same timer. Each channel having its own amplitude, 
 ...
 ===============================================================================
    ...
    - The Timer 7 is configured to generate an external trigger on TRGO each 2.5us
      so the period will the period will be 2.5us x 2 x AMPLITUDE
      i.e. 5.12ms on DAC1 and 20.48ms on DAC2
