/**
  ******************************************************************************
  * @file    13_DualMode_SimultaneousHWTriggerWithSingleTriangle/main.c 
  * @author  MCD Application Team
  * @version V1.0.0
  * @date    05-March-2014
  * @brief   This code example shows how to configure the DAC in dual mode 
  *          in order to generate two simultaneous triangle waves, each channel triggered 
  *          by the same timer. Each channel having the same triangle wave
  *          with the same amplitude and same frequency but different offset.
 ===============================================================================
                    #####       MCU Resources     #####
 ===============================================================================
   - RCC
 ...
 ===============================================================================
    ...
    - The DAC is configured to generate the same amplitude  triangle wave on 
      each channel.
    - The Timer 7 is configured to generate an external trigger
      on TRGO each 2.5us : the period will be 5.12ms
...
/**
  ...
  *         and the amplitude in the MAMPx[3:0] bits = 1001 for a 1023-bits amplitude 
...
__INLINE void ConfigureDAC(void)
{
  ...
  /* (2) Configure WAVEx at 10 and LFSR mask amplitude (MAMPx) at 1001 for a 1023-bits amplitude, 
  ...
  DAC->CR |= DAC_CR_WAVE1_1 | DAC_CR_WAVE2_1 \
           | DAC_CR_MAMP1_3 | DAC_CR_MAMP1_0 | DAC_CR_MAMP2_3 | DAC_CR_MAMP2_0 \
