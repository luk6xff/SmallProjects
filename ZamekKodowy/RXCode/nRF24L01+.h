/**
 * The Library for nRF24L01+ module written by Lukasz Uszko 07.02.2012
 *
 *
 *
 */
...
#define NUMBER_OF_BYTES_IN_FIFO  _30_Bytes			// default value of how many bytes you can send/receive to/from the FIFO (the same value ought to be set in RX_PW_Px registers )
