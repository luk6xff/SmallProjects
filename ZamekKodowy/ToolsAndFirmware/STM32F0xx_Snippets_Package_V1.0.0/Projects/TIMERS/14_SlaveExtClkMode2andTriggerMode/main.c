/**
 ...
 ===============================================================================
    - This example configures the TIM1 in order to start the counter in response 
      ...
      A wave generator can be connected to TIM1_ETR.
      ...
      monitored in live. The counter value is also used to toggle the led each time 
      the counter value is a multiple of 0x80. This allows to check the counter 
      is started.
