/**
  ******************************************************************************
  * @file    06_DualMode_TriggerWithDifferentLFSR/main.c 
  * @author  MCD Application Team
  * @version V1.0.0
  * @date    05-March-2014
  * @brief   This code example shows how to configure the DAC in dual mode 
  *          in order to generate two independent signal, each channel triggered 
  *          by its own timer. Each channel having its own pseudonoise generated 
  *          with the signal with a different amplitude.
 ===============================================================================
                    #####       MCU Resources     #####
 ===============================================================================
   - RCC
 ...
 ===============================================================================
    - The code performs the DAC configuration and provides data in order 
      to generate fixed signal on the DAC outputs PA4 and PA5.
    - The DAC is configured to add a different pseudonoise thru the LFSR on 
      each channel.
...
/**
  ...
  *         LFSR mask value in the MAMP1[3:0] bits = 1000 for a 511-bits amplitude 
  *         LFSR mask value in the MAMP2[3:0] bits = 0111 for a 255-bits amplitude 
...
__INLINE void  ConfigureDAC(void)
{
  ...
  /* (2) Configure WAVEx at 01 and LFSR mask amplitude (MAMPx) at 1000 for a 511-bits amplitude,
         LFSR mask amplitude (MAMP2) at 0111 i.e. a 255-bits amplitude for ch2, 
