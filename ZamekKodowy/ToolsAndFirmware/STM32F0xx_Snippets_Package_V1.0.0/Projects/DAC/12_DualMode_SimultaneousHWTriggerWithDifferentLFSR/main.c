/**
  ******************************************************************************
  * @file    12_DualMode_SimultaneousHWTriggerWithDifferentLFSR/main.c 
  ...
  *          generated with the signal with a different amplitude.
 ===============================================================================
                    #####       MCU Resources     #####
 ===============================================================================
   - RCC
 ...
 ===============================================================================
    ...
    - The Timer 7 is configured to generate an external trigger
      on TRGO each 2.5us for each channel.  
...
/**
  ...
  *         and on DAC2_OUT both synchronized by TIM7 HW trigger.
...
__INLINE void  ConfigureDAC(void)
{
  ...
  /* (2) Configure WAVEx at 01 and LFSR mask amplitude (MAMPx) at 1000 for a 511-bits amplitude,
         set LFSR mask amplitude (MAMP2) at 0111 i.e. a 255-bits amplitude for ch2, 
